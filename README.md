...
# インストール方法
## pipの場合
- インストール方法: `pip install git+https://github.com/Fuji-no-yama/atlas-python-sdk@1.3.0`
- アップグレード方法: `pip install -U git+https://github.com/Fuji-no-yama/atlas-python-sdk@1.3.0`
- 削除方法: `pip uninstall atlas`

## uvの場合
- インストール・アップグレード方法: `uv add git+https://github.com/Fuji-no-yama/atlas-python-sdk --tag 1.3.0`
